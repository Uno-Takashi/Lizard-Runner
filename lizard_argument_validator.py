...
parser.add_argument("-verbose", choices=["true", "false"], type=str, default="false")
...
parser.add_argument(
    "-warnings_only", choices=["true", "false"], type=str, default="false"
)
parser.add_argument(
    "-warning_msvs", choices=["true", "false"], type=str, default="false"
)
parser.add_argument("-ignore_warnings", type=str, default="None")
parser.add_argument("-exclude", type=str, default="None")
parser.add_argument("-working_threads", type=int)
parser.add_argument("-xml", choices=["true", "false"], type=str, default="false")
parser.add_argument("-html", choices=["true", "false"], type=str, default="false")
parser.add_argument("-modified", choices=["true", "false"], type=str, default="false")
